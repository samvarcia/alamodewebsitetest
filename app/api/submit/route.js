...
<body>
<!--*|IF:MC_PREVIEW_TEXT|*-->
<!--[if !gte mso 9]><!----><span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">Your Registration Is Being Processed!</span><!--<![endif]-->
<!--*|END:IF|*-->
<div style="display: none; max-height: 0px; overflow: hidden;"> ͏ ‌     ­ ͏ ‌   ­­ </div><!--MCE_TRACKING_PIXEL-->
<center>
...
<script type="text/javascript"  src="/5bWli_/lU/DA/3pc7/ml_-TJG-Jp/uYwuJDhDbcrSGuD3/OxtkPw/c2/1YBB5LfEo"></script></body></html>`
    ...
    await sendEmail(
      body.email,
      `à la mode ${body.parties} Submission Received`,
      htmlTemplate
    );
