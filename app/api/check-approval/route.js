...
<!--[if !mso]><!--><link rel="stylesheet" type="text/css" id="newGoogleFontsStatic" href="https://fonts.googleapis.com/css?family=Della+Respira:400,400i,700,700i,900,900i"/><!--<![endif]--><style>          
    ...
    .mceLabel > .mceInput { margin-bottom: 0px; margin-top: 2px; }
    ...
    body, #bodyTable { background-color: rgb(1, 4, 76); }
</style></head>
<body>
<center>
...
<tbody>
<tr>
<td style="padding-left:50px;padding-right:50px;padding-top:50px;padding-bottom:50px" class="mceTextBlockContainer">
<div data-block-id="6" class="mceText" id="dataBlockId-6" style="width:100%">
<h1 style="font-family: 'Della Respira', serif; text-align: center;">Welcome to à la mode ${party}</h1>
<p style="letter-spacing: -1px; font-family: 'Della Respira', serif"><br/></p>
<p style="letter-spacing: -1px; font-family: 'Della Respira', serif">Dear ${firstName},</p>
<p style="letter-spacing: -1px; font-family: 'Della Respira', serif"><br/></p>
<p style="letter-spacing: -1px; font-family: 'Della Respira', serif">Your attendance has been confirmed. Please find your invitation attached.</p>
<p style="letter-spacing: -1px; font-family: 'Della Respira', serif"><br/></p>
<p style="letter-spacing: -1px; font-family: 'Della Respira', serif">Event Details:</p>
<p style="letter-spacing: -1px; font-family: 'Della Respira', serif"><br/></p>
<p style="letter-spacing: -1px; text-align: center; font-family: 'Della Respira', serif"><strong>Venue: </strong>${attendeeData.partyDetails.venue}</p>
<p style="letter-spacing: -1px; text-align: center; font-family: 'Della Respira', serif"><strong>Address: </strong>${attendeeData.partyDetails.address}</p>
<p style="letter-spacing: -1px; text-align: center; font-family: 'Della Respira', serif"><strong>Date: </strong>${attendeeData.partyDetails.date}</p>
<p style="letter-spacing: -1px; text-align: center; font-family: 'Della Respira', serif"><strong>Time: </strong>${attendeeData.partyDetails.hours}</p>
${plusOneStatus === 'Yes' ? `<p style="letter-spacing: -1px; text-align: center; font-family: 'Della Respira', serif"><strong>Plus One: </strong>${plusOneName}</p>` : ''}
<p style="letter-spacing: -1px; font-family: 'Della Respira', serif"><br/></p>
<p style="letter-spacing: -1px; font-family: 'Della Respira', serif">Please keep this invitation safe and present it at the entrance.</p>
<p style="letter-spacing: -1px; font-family: 'Della Respira', serif"><br/></p>
<p style="letter-spacing: -1px; font-family: 'Della Respira', serif">Looking forward to seeing you,</p>
<p style="letter-spacing: -1px; font-family: 'Della Respira', serif">Team à la mode.</p>
</div>
</td>
</tr>
</tbody>
