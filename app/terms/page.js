  ...
  return (
    <motion.main className={styles.checkin}>
        ...
        <motion.div 
            ...
            >
                <div className={styles.topTerms}>
                    <div className={styles.topTermsCont}>
            ...
            <div className={styles.terms}>
                ...
                <h2>Eligibility for Attendance</h2>
                <ul>
                ...
                <h2>Plus One Policy and Liability</h2>
                <ul>
                ...
                <h2>International Laws and Regulations</h2>
                <ul>
